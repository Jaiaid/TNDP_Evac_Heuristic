...
if  __name__ == "__main__":
    ...
    parser.add_argument("-mo", "--matsim_data_output_dir", help="output directory path to dump generated data for matsim", required=True)
    parser.add_argument("-co", "--customsim_data_output_dir", help="output directory path to dump generated data for custom simulator", required=True)
